    ...
    <PageFrame>
      <section className="mx-auto max-w-5xl px-6 py-28">
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-body text-xs uppercase tracking-[0.3em] text-kasavu/70">DJ Night</p>
            <h1 className="mt-3 font-display text-4xl font-bold text-kasavu sm:text-5xl">
              Reserve your DJ night pass
            </h1>
            <p className="mt-4 max-w-2xl text-sm text-ivory/70">
              Book your spot on the dance floor for a premium DJ experience during Aarpo'26.
            </p>
          </div>
          <Link
            to="/events"
        ...
        <Registration initialTab="dj" showTabs={false} />
      </section>
    </PageFrame>
  );
}
